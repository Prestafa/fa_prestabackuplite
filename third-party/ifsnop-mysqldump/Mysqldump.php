...
namespace FaThirdParty\Ifsnop\Mysqldump;
...
class Mysqldump
{
    ...
    */
    ...
    {
        $noStructure =& $this->dumpSettings['no-structure'];
        ...
        foreach ($this->tables as $table) {
            ...
            if (
                true !== $noStructure
                && !(is_array($noStructure) && $this->matches($table, $noStructure))
            ) {
                $this->getTableStructure($table);
            } else {
                $this->tableColumnTypes[$table] = $this->getTableColumnTypes($table);
            }
